      ...
      <section className="bg-slate-900 py-20 sm:py-24 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-blue-200 mb-4">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={stat.label} className="group rounded-3xl border border-white/10 bg-white/5 p-8 transition duration-500 hover:bg-white/10 hover:border-white/20 hover:-translate-y-2 shadow-xl">
                <p className="text-4xl sm:text-5xl font-black text-white font-montserrat group-hover:text-[var(--cj-red)] transition-colors">{stat.value}</p>
                <p className="mt-4 text-lg font-bold text-[var(--cj-blue-300)] font-montserrat">{stat.label}</p>
