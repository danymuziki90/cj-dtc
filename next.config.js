...
const nextConfig = {
  ...
  typescript: {
    ignoreBuildErrors: true, // Legacy API routes have pre-existing TS issues; UI is fully typed
  },
  images: {
    remotePatterns: [
  ...
  async redirects() {
    return [
      ...
      { source: '/student/assignments', destination: '/fr/espace-etudiants', permanent: true },
      ...
      { source: '/:locale/student/assignments', destination: '/:locale/espace-etudiants', permanent: true },
