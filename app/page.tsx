...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-blue-950 overflow-hidden">
        {/* Advanced Animated Background */}
        <div className="absolute inset-0">
          {/* Dynamic Grid Pattern */}
          <div className="absolute inset-0">
            <div className="absolute inset-0 bg-grid-pattern opacity-10"></div>
            <div className="absolute inset-0 bg-gradient-to-r from-blue-600/5 via-blue-600/5 to-red-600/5 animate-pulse"></div>
          </div>
          
          {/* Enhanced Floating Orbs */}
          <div className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-br from-blue-600 to-blue-500 rounded-full filter blur-3xl opacity-40 animate-pulse"></div>
          <div className="absolute top-40 right-20 w-80 h-80 bg-gradient-to-br from-blue-600 to-blue-500 rounded-full filter blur-3xl opacity-35 animate-pulse delay-1000"></div>
          <div className="absolute bottom-20 left-1/4 w-72 h-72 bg-gradient-to-br from-red-600 to-red-500 rounded-full filter blur-3xl opacity-30 animate-pulse delay-2000"></div>
          <div className="absolute bottom-40 right-1/3 w-64 h-64 bg-gradient-to-br from-red-600 to-red-500 rounded-full filter blur-3xl opacity-35 animate-pulse delay-3000"></div>
          
          {/* Additional Moving Elements */}
          <div className="absolute top-1/4 left-1/3 w-3 h-3 bg-gradient-to-r from-blue-400 to-blue-400 rounded-full animate-ping opacity-75"></div>
          <div className="absolute top-3/4 right-1/4 w-3 h-3 bg-gradient-to-r from-blue-400 to-red-400 rounded-full animate-ping opacity-75 delay-1000"></div>
          <div className="absolute bottom-1/4 left-1/2 w-3 h-3 bg-gradient-to-r from-red-400 to-red-400 rounded-full animate-ping opacity-75 delay-2000"></div>
          ...
          <div className="absolute top-0 left-0 w-full h-full">
            ...
            <div className="absolute top-40 right-20 w-24 h-0.5 bg-gradient-to-r from-transparent via-blue-400 to-transparent animate-pulse delay-500"></div>
            <div className="absolute bottom-32 left-1/4 w-40 h-0.5 bg-gradient-to-r from-transparent via-red-400 to-transparent animate-pulse delay-1000"></div>
          </div>
        </div>
        ...
        <nav className="relative z-20 flex justify-between items-center px-4 sm:px-6 py-4 sm:py-6 backdrop-blur-md bg-white/5 border-b border-white/10">
          <div className="flex items-center space-x-2 sm:space-x-4">
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl blur-xl opacity-60 group-hover:opacity-80 transition-all duration-300 group-hover:scale-110"></div>
              <div className="relative w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-2xl group-hover:scale-105 transition-all duration-300">
          ...
          <div className="hidden md:flex items-center space-x-6 sm:space-x-10">
            ...
            <Link href="/fr/admin/dashboard" className="px-4 sm:px-6 py-2 sm:py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl font-bold text-sm sm:text-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              Admin
            </Link>
          </div>
        </nav>
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 py-12 sm:py-20 lg:py-32">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 sm:gap-16 lg:gap-24 items-center min-h-[600px] sm:min-h-[700px] lg:min-h-[800px]">
            ...
            <div className="space-y-6 sm:space-y-8 lg:space-y-12">
              {/* Premium Badge 3.0 */}
              <div className="inline-flex items-center px-4 sm:px-6 lg:px-10 py-3 sm:py-4 lg:py-5 bg-gradient-to-r from-blue-600/30 to-blue-600/30 backdrop-blur-lg border border-white/30 rounded-full text-white font-bold text-sm sm:text-base lg:text-lg shadow-2xl">
                <span className="w-3 h-3 sm:w-4 sm:h-4 bg-gradient-to-r from-blue-400 to-blue-500 rounded-full mr-3 sm:mr-5 animate-pulse shadow-xl shadow-blue-400/50"></span>
                <span className="flex items-center">
                  🏆 Leader de la formation professionnelle en Afrique
                  <span className="ml-2 sm:ml-3 text-red-400 font-bold">depuis 2010</span>
                </span>
              </div>
              ...
              <div className="space-y-4 sm:space-y-6 lg:space-y-8">
                <h1 className="text-4xl sm:text-5xl lg:text-7xl xl:text-9xl font-black leading-tight tracking-tight">
                  <span className="bg-gradient-to-r from-blue-400 via-blue-300 to-blue-400 bg-clip-text text-transparent drop-shadow-2xl animate-pulse">
                    CJ
                  </span>
                  <br />
                ...
                <p className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl text-blue-100 leading-relaxed max-w-2xl sm:max-w-3xl lg:max-w-4xl font-light">
                  ...
                  <span className="font-bold bg-gradient-to-r from-red-400 to-red-400 bg-clip-text text-transparent text-xl sm:text-2xl lg:text-3xl xl:text-4xl"> d'excellence</span>. 
                  Rejoignez nos <span className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-blue-400">5000+</span> diplômés qui réussissent.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-8 lg:gap-12 pt-6 sm:pt-8 lg:pt-10">
                <div className="group relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-600 rounded-2xl sm:rounded-3xl blur-xl sm:blur-2xl opacity-30 group-hover:opacity-50 transition-all duration-300 group-hover:scale-110"></div>
                  ...
                  <div className="w-full h-2 sm:h-3 bg-gradient-to-r from-blue-500 to-blue-500 rounded-full mt-2 sm:mt-4 group-hover:scale-x-110 transition-all duration-300 origin-left"></div>
                </div>
                <div className="group relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-600 rounded-2xl sm:rounded-3xl blur-xl sm:blur-2xl opacity-30 group-hover:opacity-50 transition-all duration-300 group-hover:scale-110"></div>
                  <div className="relative text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-black text-white mb-2 sm:mb-3 group-hover:scale-110 transition-all duration-300">
                ...
                <div className="group relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-red-600 rounded-2xl sm:rounded-3xl blur-xl sm:blur-2xl opacity-30 group-hover:opacity-50 transition-all duration-300 group-hover:scale-110"></div>
                  <div className="relative text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-black text-white mb-2 sm:mb-3 group-hover:scale-110 transition-all duration-300">
                    50+
                  </div>
                  <div className="text-blue-200 text-xs sm:text-sm font-bold uppercase tracking-wider">Partenaires</div>
                  <div className="w-full h-2 sm:h-3 bg-gradient-to-r from-blue-500 to-red-500 rounded-full mt-2 sm:mt-4 group-hover:scale-x-110 transition-all duration-300 origin-left"></div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 lg:gap-8 pt-6 sm:pt-8 lg:pt-12">
                <Link 
                  href='/fr/formations' 
                  className="group relative px-6 sm:px-8 lg:px-12 py-3 sm:py-4 lg:py-6 bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 text-white rounded-xl sm:rounded-2xl font-black text-sm sm:text-base lg:text-xl hover:shadow-3xl transform hover:-translate-y-2 sm:hover:-translate-y-3 transition-all duration-300 overflow-hidden"
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8 lg:gap-10 pt-4 sm:pt-6 lg:pt-8">
                <div className="flex items-center text-blue-200 text-sm sm:text-base lg:text-lg font-bold group">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mr-3 sm:mr-4 group-hover:scale-110 sm:group-hover:scale-125 transition-all duration-300 shadow-lg">
                ...
                <div className="flex items-center text-blue-200 text-sm sm:text-base lg:text-lg font-bold group">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center mr-3 sm:mr-4 group-hover:scale-110 sm:group-hover:scale-125 transition-all duration-300 shadow-lg">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="relative group">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-600/40 via-blue-600/40 to-red-600/40 rounded-2xl sm:rounded-3xl transform rotate-6 blur-2xl sm:blur-3xl group-hover:rotate-3 transition-all duration-700 group-hover:scale-110"></div>
              <div className="absolute inset-0 bg-gradient-to-bl from-blue-600/30 via-blue-600/30 to-blue-600/30 rounded-2xl sm:rounded-3xl transform -rotate-6 blur-2xl sm:blur-3xl group-hover:-rotate-3 transition-all duration-700 group-hover:scale-110"></div>
              <div className="absolute inset-0 bg-gradient-to-r from-red-600/20 via-red-600/20 to-red-600/20 rounded-2xl sm:rounded-3xl transform rotate-12 blur-xl sm:blur-2xl group-hover:rotate-6 transition-all duration-700 group-hover:scale-105"></div>
              ...
              <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl sm:rounded-3xl shadow-2xl sm:shadow-3xl overflow-hidden border-2 border-white/30 group-hover:shadow-3xl sm:group-hover:shadow-4xl transition-all duration-300">
                ...
                <div className="absolute top-6 sm:top-8 lg:top-10 right-6 sm:right-8 lg:right-10 bg-gradient-to-r from-red-400 via-red-500 to-red-500 text-white px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 rounded-xl sm:rounded-2xl font-bold shadow-xl sm:shadow-2xl animate-bounce">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/95 to-transparent p-4 sm:p-6 lg:p-10">
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-3">
                      {[...Array(5)].map((_, i) => (
                        <svg key={i} className="w-4 h-4 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-red-400 fill-current drop-shadow-lg sm:drop-shadow-xl" viewBox="0 0 20 20">
              ...
              <div className="absolute top-8 sm:top-12 lg:top-16 -left-8 sm:-left-12 lg:-left-16 bg-white/95 backdrop-blur-lg rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-2xl sm:shadow-3xl transform rotate-12 hover:rotate-0 transition-all duration-500 hover:scale-110 group-hover:translate-x-4 sm:group-hover:translate-x-6">
                <div className="flex items-center space-x-3 sm:space-x-4 lg:space-x-5">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg sm:shadow-xl">
