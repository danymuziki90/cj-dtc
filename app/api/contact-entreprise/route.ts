...
export const POST = apiHandler(async (req: NextRequest) => {
  const { company, contactName, position, email, phone, sector, employees, needType, message } = b2bContactSchema.parse(await req.json())
  ...
  const html = `
    <div style="font-family:Arial,sans-serif;max-width:680px;margin:0 auto;">
      <div style="background:#0A4FB3;padding:28px 32px;border-radius:12px 12px 0 0;">
      ...
      <div style="background:#f8fafc;padding:28px 32px;border-radius:0 0 12px 12px;border:1px solid #e2e8f0;border-top:none;">
        ...
        <h3 style="color:#0A4FB3;font-size:15px;margin-top:0;">Organisation</h3>
        ...
        <h3 style="color:#0A4FB3;font-size:15px;">Contact</h3>
        <table style="width:100%;font-size:14px;border-collapse:collapse;">
          ...
          <tr><td style="padding:6px 0;color:#64748b;">Email</td><td style="padding:6px 0;color:#0f172a;"><a href="mailto:${email}" style="color:#0A4FB3;">${email}</a></td></tr>
          <tr><td style="padding:6px 0;color:#64748b;">Téléphone</td><td style="padding:6px 0;color:#0f172a;">${phone || '—'}</td></tr>
        </table>

        <hr style="border:none;border-top:1px solid #e2e8f0;margin:20px 0;">

        <h3 style="color:#0A4FB3;font-size:15px;">Besoin exprimé</h3>
        <p style="font-size:14px;color:#0f172a;background:#fff;border-left:4px solid #E53935;padding:12px 16px;border-radius:0 8px 8px 0;">
