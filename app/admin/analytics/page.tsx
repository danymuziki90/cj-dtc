                ...
                <div className="bg-white p-6 rounded-lg shadow border">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-center">
                            ...
                            <div>
                                <div className="text-xl font-semibold text-blue-600">{data.insertionStats.placed}</div>
                        ...
                        {data.paymentBreakdown.map((payment, index) => (
                            <div key={index} className="flex items-center justify-between">
                                ...
                                <div className="flex items-center space-x-2">
                                    <div className="w-24 bg-gray-200 rounded-full h-2">
                                        <div
                                            className={`h-2 rounded-full ${payment.status === 'paid' ? 'bg-blue-600' :
                                                payment.status === 'partial' ? 'bg-red-600' : 'bg-red-600'
                                                }`}
