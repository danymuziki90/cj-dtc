                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                                        {evaluation.contentRating && (
                                            <div className="text-center">
                                                ...
                                                <div className="text-red-400">{renderStars(evaluation.contentRating)}</div>
                                            </div>
                                        )}
                                        {evaluation.instructorRating && (
                                            <div className="text-center">
                                                <div className="text-xs text-gray-500">Formateur</div>
                                                <div className="text-red-400">{renderStars(evaluation.instructorRating)}</div>
                                            </div>
                                        )}
                                        {evaluation.materialRating && (
                                            <div className="text-center">
                                                <div className="text-xs text-gray-500">Supports</div>
                                                <div className="text-red-400">{renderStars(evaluation.materialRating)}</div>
                                            </div>
                                        )}
                                        {evaluation.organizationRating && (
                                            <div className="text-center">
                                                <div className="text-xs text-gray-500">Organisation</div>
                                                <div className="text-red-400">{renderStars(evaluation.organizationRating)}</div>
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {evaluation.strengths && (
                                            <div>
                                                <h4 className="text-sm font-medium text-blue-700 mb-1">Points forts:</h4>
                                                <p className="text-sm text-gray-700 bg-blue-50 p-2 rounded">{evaluation.strengths}</p>
                                            </div>
                                        )}
