...
export default function HomePage() {
  ...
  const heroSlides = [
    {
      ...
      description:
        "Rejoignez plus de 500 professionnels formés dans 10 pays africains",
      cta: "Découvrir nos formations",
      ctaLink: `/${locale}/formations`,
  ...
  const formations = [
    {
      ...
      level: "Avancé",
      description:
        "Maîtrisez les stratégies RH modernes adaptées au contexte africain",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden hero-bg-unified">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
              Formation de leadership et management d'excellence pour les
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Des programmes certifiants conçus par des experts internationaux
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Programmes conçus selon les standards Harvard et SHRM,
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      95% de nos diplômés obtiennent une promotion ou un
                      meilleur poste dans les 6 mois
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Accès à notre réseau de partenaires et d'anciens diplômés
                      dans 10+ pays
                    </p>
                  </div>
                </div>
      ...
      <footer className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <Link
                    href={`/${locale}/formations/leadership`}
                    className="hover:text-white"
                  >
                    Leadership
                  </Link>
                ...
                <li>
                  <Link
                    href={`/${locale}/formations/marketing`}
                    className="hover:text-white"
                  >
                    Digital Marketing
                  </Link>
                ...
                <li>
                  <Link
                    href={`/${locale}/formations/family-business`}
                    className="hover:text-white"
                  >
                    Family Business
                  </Link>
                ...
                <li>
                  <Link
                    href={`/${locale}/formations/cj-master`}
                    className="hover:text-white"
                  >
                    CJ Master System
                  </Link>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>
              &copy; 2024 CJ DTC. Tous droits réservés. |
              <Link
