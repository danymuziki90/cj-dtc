...
export default function FormationsPage() {
  ...
  const formations = [
    {
      ...
      students: 450,
      description:
        "Maîtrisez les stratégies RH modernes adaptées au contexte africain avec cette certification complète.",
      objectives: [
    ...
    },
    {
      ...
      students: 320,
      description:
        "Développez votre leadership transformationnel et apprenez à inspirer vos équipes vers l'excellence.",
      objectives: [
    ...
    },
    {
      ...
      students: 280,
      description:
        "Maîtrisez les techniques du marketing digital pour développer votre présence en ligne.",
      objectives: [
    ...
    },
    {
      ...
      students: 180,
      description:
        "Pérennisez votre entreprise familiale avec des stratégies de gouvernance éprouvées.",
      objectives: [
    ...
    },
    {
      ...
      students: 95,
      description:
        "Le programme complet d'excellence managériale pour les leaders de demain.",
      objectives: [
    ...
    },
    {
      ...
      students: 220,
      description:
        "Maîtrisez les protocoles et relations internationales dans un contexte global.",
      objectives: [
      ...
      prerequisites:
        "Poste à responsabilité internationale ou projet d'expansion",
  ...
  const filteredFormations = formations
    .filter((formation) => {
      ...
      const matchesLevel =
        selectedLevel === "all" || formation.level === selectedLevel;
      const matchesFormat =
        selectedFormat === "all" || formation.format === selectedFormat;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed mb-8">
              Des programmes certifiants conçus par des experts pour accélérer
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-white mb-1">
                  {(
                    formations.reduce((sum, f) => sum + f.rating, 0) /
                    formations.length
                  ).toFixed(1)}
                </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-3">
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-semibold ${getCategoryColor(formation.category)}`}
                  >
                    {formation.category}
                  </span>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    {(() => {
                      ...
                      return <FormatIcon className="w-4 h-4 text-gray-400" />;
                    })()}
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    <span>Découvrir ce parcours</span>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Notre équipe peut vous aider à trouver la formation idéale pour vos
            objectifs
          </p>
