          ...
          <div className="space-y-3">
            {assignments.slice(0, 3).map((assign: any) => {
              ...
              return (
                <div
                  key={assign.id}
                  className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-slate-100 bg-white p-4 text-xs shadow-sm hover:border-blue-100 transition"
                >
                  <div className="space-y-1">
                    <span className="text-[9px] font-bold uppercase text-[var(--cj-blue)] bg-blue-50 px-2 py-0.5 rounded border border-blue-100">
                    ...
                    <p className="text-[10px] text-slate-400">
                      Formation : {assign.formation?.title}
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      onClick={() =>
                        setSelectedAssignmentForSubmission(assign)
                      }
                      className="inline-flex items-center gap-1 rounded-xl bg-[var(--cj-blue)] px-3 py-1.5 text-xs font-bold text-white hover:bg-[var(--cj-blue-700)] transition shadow-sm"
                    >
                      <Upload className="w-3 h-3" />
                      {hasSubmission ? "Rendre à nouveau" : "Déposer"}
                    </button>
                  </div>
                </div>
              );
