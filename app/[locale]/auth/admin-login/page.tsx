      ...
      <div className="max-w-md w-full space-y-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`mt-1 appearance-none relative block w-full px-3 py-2 border rounded-lg placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-red-500 focus:border-red-500 focus:z-10 sm:text-sm ${
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className={`mt-1 appearance-none relative block w-full px-3 py-2 pr-10 border rounded-lg placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-red-500 focus:border-red-500 focus:z-10 sm:text-sm ${
        ...
        <div className="text-center space-y-4">
          <div className="text-sm text-gray-600">
            Vous êtes étudiant?{' '}
            <Link href="/auth/student-login" className="font-medium text-blue-600 hover:text-blue-500">
              Connexion étudiant
            </Link>
          </div>
