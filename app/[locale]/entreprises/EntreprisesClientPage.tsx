  ...
  return (
    <div className="bg-slate-50 text-slate-900">
      ...
      <section className="bg-white py-8 sm:py-10 lg:py-12 border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-5 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {whyCards.map((card, i) => (
              <div key={i} className="group relative overflow-hidden rounded-2xl border border-slate-100 bg-slate-50 p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-[var(--cj-blue)]/20">
                <div className="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-[var(--cj-blue)]/10 transition group-hover:bg-[var(--cj-blue)]/20">
                  <card.icon className="h-5 w-5 text-[var(--cj-blue)]" />
                </div>
                <h3 className="mb-2 text-base sm:text-lg font-bold text-slate-900">{card.title}</h3>
                <p className="text-xs sm:text-sm leading-relaxed text-slate-600">{card.desc}</p>
      ...
      {/* ════════════════════════════════════════
          3. SOLUTIONS
      ════════════════════════════════════════ */}
      <section id="solutions" className="scroll-mt-20 bg-slate-50 py-8 sm:py-10 lg:py-12 border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-6 sm:mb-8 text-center">
          ...
          <div className="grid gap-5 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {visible.map((sol, i) => (
              <article key={i} className="flex flex-col rounded-2xl border border-slate-200 bg-white p-5 sm:p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-[var(--cj-blue)]/30">
                <div className="mb-3 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--cj-blue)]/10">
                  <sol.icon className="h-5 w-5 text-[var(--cj-blue)]" />
                </div>
                <h3 className="mb-1 text-base font-bold text-slate-900">{sol.title}</h3>
                <p className="mb-2.5 flex-1 text-xs leading-relaxed text-slate-600">{sol.desc}</p>
                ...
                <div className="mb-3 rounded-lg bg-slate-50 px-3 py-1.5 text-xs">
                  <span className="font-bold text-slate-500">{t.audience} : </span>
                  <span className="text-slate-700">{sol.audience}</span>
                </div>
                <a href="#contact" className="mt-auto inline-flex items-center gap-1.5 text-xs font-semibold text-[var(--cj-blue)] hover:text-[var(--cj-red)] transition-colors">
                  {t.learnMore}
          ...
          <div className="mt-6 text-center">
            <button onClick={() => setShowAll(v => !v)}
              className="inline-flex items-center gap-2 rounded-xl border-2 border-[var(--cj-blue)] px-5 py-2 text-xs font-bold text-[var(--cj-blue)] transition hover:bg-[var(--cj-blue)] hover:text-white">
      ...
      <section className="bg-white py-8 sm:py-10 lg:py-12 border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 sm:grid-cols-3 lg:grid-cols-5">
            {sectors.map((s, i) => (
              <div key={i} className="group flex flex-col items-center rounded-2xl border border-slate-200 bg-slate-50 p-4 text-center transition hover:-translate-y-1 hover:border-[var(--cj-blue)]/30 hover:bg-[var(--cj-blue)]/5 hover:shadow-md">
                <div className="mb-2 flex h-10 w-10 items-center justify-center rounded-xl bg-white shadow-sm transition group-hover:bg-[var(--cj-blue)]/10">
      ...
      {/* ════════════════════════════════════════
          5. MÉTHODE
      ════════════════════════════════════════ */}
      <section className="bg-gradient-to-br from-[#001B47] via-[var(--cj-blue)] to-[#0B3A8E] py-8 sm:py-10 lg:py-12 rounded-3xl my-6 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-6 sm:mb-8 text-center">
            <span className="mb-2 inline-block rounded-full border border-white/20 bg-white/10 px-4 py-1 text-xs font-bold uppercase tracking-widest text-white/80">{t.methodBadge}</span>
          ...
          <div className="grid gap-3.5 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {steps.map((step, i) => (
              <div key={i} className="relative rounded-2xl border border-white/15 bg-white/10 p-4 sm:p-5 backdrop-blur-sm transition hover:bg-white/15">
                <span className="mb-1.5 inline-block text-2xl sm:text-3xl font-black text-white/20 leading-none">{step.n}</span>
                <div className="mb-2.5 h-0.5 w-8 rounded-full bg-[var(--cj-red)]" />
                <h3 className="mb-1 text-sm sm:text-base font-bold text-white">{step.title}</h3>
      ...
      <section className="bg-white py-8 sm:py-10 lg:py-12 border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-4 sm:gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {differs.map((d, i) => (
              <div key={i} className="flex gap-3.5 rounded-2xl border border-slate-100 bg-slate-50 p-4 sm:p-5 transition hover:shadow-md">
                <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl bg-[var(--cj-red)]/10">
                  <d.icon className="h-4 w-4 text-[var(--cj-red)]" />
                </div>
                <div>
      ...
      <section className="bg-slate-50 py-8 sm:py-10 lg:py-12 border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-6 grid grid-cols-2 gap-3.5 sm:grid-cols-4">
            {TRUST_STATS.map(s => (
              <div key={s.value} className="rounded-2xl border border-slate-200 bg-white p-3.5 sm:p-4 text-center shadow-sm">
                <p className="text-2xl sm:text-3xl lg:text-4xl font-black text-[var(--cj-blue)]">{s.value}</p>
                <p className="mt-0.5 text-xs font-semibold text-slate-500">{isFr ? s.fr : s.en}</p>
              </div>
            ))}
          </div>
          {/* Témoignages */}
          <div className="grid gap-3.5 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {(isFr ? [
              ...
              <blockquote key={i} className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm">
                <p className="mb-3 text-xs sm:text-sm leading-relaxed text-slate-700 italic">{item.quote}</p>
                <footer>
            ...
            {faqItems.map((item, i) => (
              <div key={i} className="overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 transition hover:border-[var(--cj-blue)]/30">
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)}
                  className="flex w-full items-center justify-between px-4 py-3 sm:px-5 sm:py-3.5 text-left">
                  <span className="pr-4 text-xs sm:text-sm font-bold text-slate-900">{item.q}</span>
                  {openFaq === i
                    ? <ChevronUp className="h-4 w-4 flex-shrink-0 text-[var(--cj-blue)]" />
                    : <ChevronDown className="h-4 w-4 flex-shrink-0 text-slate-400" />}
                </button>
                {openFaq === i && (
                  <div className="border-t border-slate-200 bg-white px-4 py-3 sm:px-5 sm:py-3.5">
      ...
      {/* ════════════════════════════════════════
          9. CTA + FORMULAIRE
      ════════════════════════════════════════ */}
      <section id="contact" className="scroll-mt-20 mt-6 sm:mt-8">
        <div className="cj-cta-banner relative overflow-hidden">
          ...
          <div className="relative z-10 grid gap-10 lg:grid-cols-2 lg:items-start text-white">
            {/* Texte gauche */}
            <div>
