  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-4 py-8">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <h1 className="mb-2 text-2xl font-bold text-slate-900">Espace Étudiant</h1>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-700">Nom d&apos;utilisateur ou e-mail</label>
            <input
              value={username}
        ...
        <p className="mt-5 text-center text-sm text-slate-600">
          ...
          <Link href="/student/register" className="font-medium text-blue-600 hover:underline">
            S&apos;inscrire
          </Link>
        </p>
      </div>
